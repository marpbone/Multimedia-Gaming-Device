...
int audio_main (void)
{
  ...
  LPC_TIM0->TCR = 1;					/* TC0 Enable */
	...
	GLCD_DisplayString(0,5,1, "Play Audio");
	GLCD_DisplayString(1,2,1, "on Computer");
	//GLCD_DisplayString(2,0,1, "________________________");
	GLCD_DisplayString(3,0,1, "Left to Exit");

	//GLCD_Bitmap(70, 105, 180, 135, MUSIC_pixel_data);
